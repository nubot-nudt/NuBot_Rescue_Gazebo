...
- Extract it and run commands below to add them into your system:  
...
- for robot only (in .sdf):  
`roslaunch nubot_launch pumbaa_lab.launch`  
- for robot + LiDAR + IMU in <strong>.xacro</strong> format:  
`roslaunch nubot_launch pumbaa_lidar_xacro.launch`  
- for robot + LiDAR + IMU in <strong>.sdf</strong> format:  
`roslaunch nubot_launch pumbaa_lidar_sdf.launch`  
